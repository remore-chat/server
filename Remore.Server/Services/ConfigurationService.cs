...
namespace Remore.Server.Services
{
    public class ConfigurationService
    {
        ...
        public ConfigurationService(ServerDbContext context, IMapper mapper, ILogger<RemoreServer> logger)
        {
            _context = context;
            _mapper = mapper;
            _logger = logger;
        ...
        public async Task<ServerConfiguration> GetServerConfigurationAsync()
        {
            ...
            if (configuration == null)
            {
                ...
                {
                    Name = "Brand new and shiny Remore Server",
                    MaxClients = 32,
                    PrivilegeKey = null
                };
